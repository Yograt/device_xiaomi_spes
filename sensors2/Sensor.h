  ...
  public:
    UdfpsSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
        : SysfsPollingOneShotSensor(
              ...
              GetPollPath(udfpsPathsEnable), "UDFPS Sensor", "aosp.sensor.udfps",
  ...
  public:
    DoubleTapSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
        : SysfsPollingOneShotSensor(
              ...
              GetPollPath(doubleTapPathsEnable), "Double Tap Sensor", "aosp.sensor.double_tap",
  ...
  public:
    SingleTapSensor(int32_t sensorHandle, ISensorsEventCallback* callback)
        : SysfsPollingOneShotSensor(
              ...
              GetPollPath(singleTapPathsEnable), "Single Tap Sensor", "aosp.sensor.single_tap",
