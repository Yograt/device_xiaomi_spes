...
echo -e "${color}Cloning vendor & kernel from Yograt${end}"
git clone https://github.com/Yograt/vendor_xiaomi_spes -b 14.0 vendor/xiaomi/spes
git clone https://github.com/Yograt/kernel_xiaomi_sm6225 --depth=1 -b NaughtySilver kernel/xiaomi/sm6225

# Lineage-21 Hardware Source
echo -e "${color}Cloning Hardware from Yograt${end}"
git clone https://github.com/Yograt/android_hardware_xiaomi.git -b lineage-21 hardware/xiaomi
